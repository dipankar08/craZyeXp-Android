...
public class tutorial9 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(tutorial9.this, "ImageButtonClicked : tutorialspoint.com",
        ...
        ck1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    Toast.makeText(tutorial9.this, " Ck1 Checked",
                            Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(tutorial9.this, " Ck1 UnChecked",
                            Toast.LENGTH_SHORT).show();
                }
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.radio0) {
                    Toast.makeText(tutorial9.this, " Radio 0",
                            Toast.LENGTH_SHORT).show();
                }
                if (checkedId == R.id.radio1) {
                    Toast.makeText(tutorial9.this, " Radio 1",
                            Toast.LENGTH_SHORT).show();
                }
                if (checkedId == R.id.radio2) {
                    Toast.makeText(tutorial9.this, " Radio 2",
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        toggleAlarm.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    Toast.makeText(tutorial9.this, " Onm",
                            Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(tutorial9.this, " OFF",
                            Toast.LENGTH_SHORT).show();
                }
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            {
                Toast.makeText(tutorial9.this,"Nothing selecetd", Toast.LENGTH_LONG).show();
            }
        });
